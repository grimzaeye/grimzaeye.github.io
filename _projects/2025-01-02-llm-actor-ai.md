...
![Actor AI System Architecture](/assets/images/portfolio/Actor%20AI-whole%20system.png){: .align-center}
...
![Actor AI Graph](/assets/images/portfolio/Actor%20AI-graph.png){: .align-center}
...
![Actor AI Radar Chart](/assets/images/portfolio/Actor%20AI-raydar%20chart.png){: .align-center}
...
{% include gallery id="gallery" caption="Actor AI 논문 연구 관련 도표 및 다각형 다이어그램" %}
